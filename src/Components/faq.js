  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>
          The For You page is solely based on the organizations that you choose
          to follow. This allows you to sort through events from organizations
          you have more interest in more easily.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          Interested or Attending, giving you a view of what your art endeavors
          could look like.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          navbar. Click on Create Event and fill out the form, once that’s done
          just click Create Event and your set! If you need to change anything
          in an event, you can always change it by clicking the update button
          and fixing your mistake, otherwise you can just delete the event by
      ...
      <div>
        ...
        <p>
          The active events tab is where you will find all your events that are
          currently in action. This is where you can update and delete them. The
          past events tab is for events that have passed - you can't change them
          even if you have a typo, live with your mistakes.
        </p>
      </div>
    </div>
  );
